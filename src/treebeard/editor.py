...
from treebeard import dependencies, ui
from treebeard.frontmatter import Frontmatter, Source, has_source, split_document, write_note
from treebeard.post_edit import reconcile_filename
...
def run_editor(editor: str, path: pathlib.Path, *, start_line: int | None = None) -> None:
    ...
    try:
        ...
        raise TreebeardError(f"editor exited with status {exc.returncode}") from exc
